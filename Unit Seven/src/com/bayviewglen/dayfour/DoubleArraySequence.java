...
public class DoubleArraySequence implements Cloneable{
	...
	public static DoubleArraySequence catenation(DoubleArraySequence s1, DoubleArraySequence s2){
		...
		DoubleArraySequence djs = new DoubleArraySequence(minimumCapacity);
		djs.data = data;
		djs.manyItems=minimumCapacity;
		djs.currentIndex=minimumCapacity;
		djs.ensureCapacity(minimumCapacity);
	...
	public void ensureCapacity(int minimumCapacity){
		...
		//(minimumCapacity+4)/5*5	
			...
			/**else{
				data = new double[minimumCapacity+1];
				
				for(int i = 0; i < minimumCapacity+1; i++){
					 = temp[i] ;
